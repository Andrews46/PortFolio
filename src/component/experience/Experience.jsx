  ...
  return (
    <div onClick={onHadleClick} id="experience" className={styles.Experience}>
      <div className={styles.container}>
        <h2>Experience</h2>
        <h3 className={styles.titleExperience}>FRONT-END DEVELOPER</h3>
        <p>
        ...
        <hr />
        <h3 className={styles.titleExperience}>LAVORO AUTONOMO</h3>
        <p>
        ...
        <hr />
        <h3 className={styles.titleExperience}>MAESTRO DI ARTI MARZIALI</h3>
        <p>
          Febbraio 2018 - Presente: Maestro di Wing Chun e difesa personale,
          membro ASI, associazione sportiva.
        </p>
        <hr />
        <h3 className={styles.titleExperience}>EDILIZIA</h3>
        <p>
